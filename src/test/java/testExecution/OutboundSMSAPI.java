...
public class OutboundSMSAPI {
	...
	public void OutBoundSMSValidData() {
		...
		Response resp = given().spec(requestSpec)
				.body(KonnectPayLoad.OutBoundSMSLowPriority_payLoad("send_sms", "OutBound_Suc", "KVGURU", "918882000001", recpList, "false", "46389", "This is my SMS API KV_SMS", "https://www.google.com", KonnectAPIConstant.str_priority_low))
	...
	public void OutBoundSMSInValidAuthentication() {
		...
		RequestSpecification requestSpec = KonnectRequestBuilder.buildReqOutBoundSMS(KonnectAPIConstant.str_KA_Account3_API_TOKEN_AUTHval);
		Response resp = given().spec(requestSpec)
				.body(KonnectPayLoad.OutBoundSMSLowPriority_payLoad("send_sms", "OutBoundSMS_InvalidAuth", "KVGURU", "918882000001", recpList, "false", "46389", "This is my SMS API KV_SMS", "https://www.google.com", KonnectAPIConstant.str_priority_low))
				.when().contentType(ContentType.JSON)
	...
	public void OutBoundSMSInValidAPIToken() {
		...
		Response resp = given().spec(requestSpec)
				.body(KonnectPayLoad.OutBoundSMSLowPriority_payLoad("send_sms", "OutBoundSMS_InvalidAPIToken", "KVGURU", "918882000001", recpList, "false", "46389", "This is my SMS API KV_SMS", "https://www.google.com", KonnectAPIConstant.str_priority_low))
				.when().contentType(ContentType.JSON)
				.post(KonnectAPIConstant.str_KA_Account3_ACCOUNT_Id+"/Messages")
				.then().log().all().extract().response();
	...
	public void OutBoundSMSInvalidURLParams() {
		...
		RequestSpecification requestSpec = KonnectRequestBuilder.buildReqOutBoundSMS(KonnectAPIConstant.str_KA_Account3_API_TOKEN_AUTHval);
		Response resp = given().spec(requestSpec)
				.body(KonnectPayLoad.OutBoundSMSLowPriority_payloadparams("send_sms", "OutBoundSMS_invalidparams", "918882000001", recpList, "false", "46389", "This is my SMS API KV_SMS", "https://www.google.com", KonnectAPIConstant.str_priority_low))
				.when().contentType(ContentType.JSON)
	...
	public void OutBoundSMSInvalidSenderNum() {
		...
		RequestSpecification requestSpec = KonnectRequestBuilder.buildReqOutBoundSMS(KonnectAPIConstant.str_KA_Account3_API_TOKEN_AUTHval);
		Response resp = given().spec(requestSpec)
				.body(KonnectPayLoad.OutBoundSMSLowPriority_payLoad("send_sms", "OutBound_InvalidSendernum", "KVGURU", "91888200000", recpList, "false", "46389", "This is my SMS API KV_SMS", "https://www.google.com", KonnectAPIConstant.str_priority_low))
				.when().contentType(ContentType.JSON)
				.post(KonnectAPIConstant.str_KA_Account3_ACCOUNT_Id+"/Messages")
				.then().log().all().extract().response();
	...
	public void OutBoundSMSEmptyParam() {
		...
		RequestSpecification requestSpec = KonnectRequestBuilder.buildReqOutBoundSMS(KonnectAPIConstant.str_KA_Account3_API_TOKEN_AUTHval);
		Response resp = given().spec(requestSpec)
				.body(KonnectPayLoad.OutBoundSMSLowPriority_payLoad("send_sms", "OutBound_InvalidSendernum", "KVGURU", "918882000001", recpList, "false", "46389", "", "https://www.google.com", KonnectAPIConstant.str_priority_low))
				.when().contentType(ContentType.JSON)
				.post(KonnectAPIConstant.str_KA_Account3_ACCOUNT_Id+"/Messages")
				.then().log().all().extract().response();
	...
	public void OutBoundSMSEmptyRecipient() throws InterruptedException {
		recpList.add("");
		//recpList.add("919886001211");
		// System.out.println(APIController.sconfig);
		...
		RequestSpecification requestSpec = KonnectRequestBuilder.buildReqOutBoundSMS(KonnectAPIConstant.str_KA_Account3_API_TOKEN_AUTHval);
		Response resp = given().spec(requestSpec)
				.body(KonnectPayLoad.OutBoundSMSLowPriority_payLoad("send_sms", "OutBound_RecipientListEmpty", "KVGURU", "918882000001", recpList, "false", "46389", "fgsgdhgd", "https://www.google.com", KonnectAPIConstant.str_priority_low))
				.when().contentType(ContentType.JSON)
				.post(KonnectAPIConstant.str_KA_Account3_ACCOUNT_Id+"/Messages")
				.then().log().all().extract().response();
